...
//our application service and interface
...
public CurrentRole:number=1;
  constructor(private _soccerService : SoccerService) {
   ...
   //update Screen variable based on currrent Game
   ...
   //get the schedule only showing game not yet scored
  private getSchedule() {
    if(this.UsingAsync){
